  ...
  describe('ChronoSheetsClient', function() {
    describe('CSFleetSummaryReportItem', function() {
      ...
      it('should create an instance of CSFleetSummaryReportItem', function() {
        // TODO: update the code to test CSFleetSummaryReportItem
      ...
      it('should have the property totalDistanceMetersFiltered (base name: "TotalDistanceMetersFiltered")', function() {
        // TODO: update the code to test the property totalDistanceMetersFiltered
        expect(instance).to.have.property('totalDistanceMetersFiltered');
        // expect(instance.totalDistanceMetersFiltered).to.be(expectedValueLiteral);
      });

      it('should have the property totalDistanceMeters (base name: "TotalDistanceMeters")', function() {
        // TODO: update the code to test the property totalDistanceMeters
        expect(instance).to.have.property('totalDistanceMeters');
        // expect(instance.totalDistanceMeters).to.be(expectedValueLiteral);
      });

      it('should have the property totalRunningCostDollarsFiltered (base name: "TotalRunningCostDollarsFiltered")', function() {
        // TODO: update the code to test the property totalRunningCostDollarsFiltered
        expect(instance).to.have.property('totalRunningCostDollarsFiltered');
        // expect(instance.totalRunningCostDollarsFiltered).to.be(expectedValueLiteral);
      });

      it('should have the property totalRunningCostDollars (base name: "TotalRunningCostDollars")', function() {
        // TODO: update the code to test the property totalRunningCostDollars
        expect(instance).to.have.property('totalRunningCostDollars');
        // expect(instance.totalRunningCostDollars).to.be(expectedValueLiteral);
      });
