  ...
  describe('ChronoSheetsClient', function() {
    describe('CSInsertOrganisationGroupRequest', function() {
      ...
      it('should create an instance of CSInsertOrganisationGroupRequest', function() {
        // TODO: update the code to test CSInsertOrganisationGroupRequest
      ...
      it('should have the property organisationGroupUserIds (base name: "OrganisationGroupUserIds")', function() {
        // TODO: update the code to test the property organisationGroupUserIds
        expect(instance).to.have.property('organisationGroupUserIds');
        // expect(instance.organisationGroupUserIds).to.be(expectedValueLiteral);
      });
