...
(function(root, factory) {
  ...
  describe('ChronoSheetsClient', function() {
    describe('CSCreateAutomationStepRequest', function() {
      ...
      it('should have the property clientTime (base name: "ClientTime")', function() {
        // TODO: update the code to test the property clientTime
        expect(instance).to.have.property('clientTime');
        // expect(instance.clientTime).to.be(expectedValueLiteral);
      });
