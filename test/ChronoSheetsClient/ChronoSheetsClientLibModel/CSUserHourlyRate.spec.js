  ...
  describe('ChronoSheetsClient', function() {
    describe('CSUserHourlyRate', function() {
      ...
      it('should create an instance of CSUserHourlyRate', function() {
        // TODO: update the code to test CSUserHourlyRate
      ...
      it('should have the property isCurrent (base name: "IsCurrent")', function() {
        // TODO: update the code to test the property isCurrent
        expect(instance).to.have.property('isCurrent');
        // expect(instance.isCurrent).to.be(expectedValueLiteral);
      });
