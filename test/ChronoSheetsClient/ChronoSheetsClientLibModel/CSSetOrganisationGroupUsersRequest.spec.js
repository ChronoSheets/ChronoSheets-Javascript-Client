  ...
  describe('ChronoSheetsClient', function() {
    describe('CSSetOrganisationGroupUsersRequest', function() {
      ...
      it('should create an instance of CSSetOrganisationGroupUsersRequest', function() {
        // TODO: update the code to test CSSetOrganisationGroupUsersRequest
      ...
      it('should have the property organisationGroupId (base name: "OrganisationGroupId")', function() {
        // TODO: update the code to test the property organisationGroupId
        expect(instance).to.have.property('organisationGroupId');
        // expect(instance.organisationGroupId).to.be(expectedValueLiteral);
      });

      it('should have the property csvUserIds (base name: "CsvUserIds")', function() {
        // TODO: update the code to test the property csvUserIds
        expect(instance).to.have.property('csvUserIds');
        // expect(instance.csvUserIds).to.be(expectedValueLiteral);
      });
