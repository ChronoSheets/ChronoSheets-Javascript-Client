...
(function(root, factory) {
  ...
  describe('ChronoSheetsClient', function() {
    describe('CSProject', function() {
      beforeEach(function() {
        instance = new ChronoSheetsApi.CSProject();
      });

      it('should create an instance of CSProject', function() {
        // TODO: update the code to test CSProject
        expect(instance).to.be.a(ChronoSheetsApi.CSProject);
      });
      ...
      it('should have the property costActual (base name: "CostActual")', function() {
        // TODO: update the code to test the property costActual
        expect(instance).to.have.property('costActual');
        // expect(instance.costActual).to.be(expectedValueLiteral);
      });
