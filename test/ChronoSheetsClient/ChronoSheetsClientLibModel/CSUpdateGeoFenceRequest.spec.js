...
(function(root, factory) {
  ...
  describe('ChronoSheetsClient', function() {
    describe('CSUpdateGeoFenceRequest', function() {
      beforeEach(function() {
        instance = new ChronoSheetsApi.CSUpdateGeoFenceRequest();
      });

      it('should create an instance of CSUpdateGeoFenceRequest', function() {
        // TODO: update the code to test CSUpdateGeoFenceRequest
        expect(instance).to.be.a(ChronoSheetsApi.CSUpdateGeoFenceRequest);
      });

      it('should have the property geofenceId (base name: "GeofenceId")', function() {
        // TODO: update the code to test the property geofenceId
        expect(instance).to.have.property('geofenceId');
        // expect(instance.geofenceId).to.be(expectedValueLiteral);
      });
