...
(function(root, factory) {
  ...
  describe('ChronoSheetsClient', function() {
    describe('CSBasicCoordinate', function() {
      beforeEach(function() {
        instance = new ChronoSheetsApi.CSBasicCoordinate();
      });

      it('should create an instance of CSBasicCoordinate', function() {
        // TODO: update the code to test CSBasicCoordinate
        expect(instance).to.be.a(ChronoSheetsApi.CSBasicCoordinate);
      });
