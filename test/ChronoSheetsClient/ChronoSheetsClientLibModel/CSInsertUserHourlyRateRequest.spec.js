  ...
  describe('ChronoSheetsClient', function() {
    describe('CSInsertUserHourlyRateRequest', function() {
      ...
      it('should create an instance of CSInsertUserHourlyRateRequest', function() {
        // TODO: update the code to test CSInsertUserHourlyRateRequest
      ...
      it('should have the property hourlyRate (base name: "HourlyRate")', function() {
        // TODO: update the code to test the property hourlyRate
        expect(instance).to.have.property('hourlyRate');
        // expect(instance.hourlyRate).to.be(expectedValueLiteral);
      });

      it('should have the property hourlyOvertimeRate (base name: "HourlyOvertimeRate")', function() {
        // TODO: update the code to test the property hourlyOvertimeRate
        expect(instance).to.have.property('hourlyOvertimeRate');
        // expect(instance.hourlyOvertimeRate).to.be(expectedValueLiteral);
      });
