  ...
  describe('ChronoSheetsClient', function() {
    describe('CSSetUsualHoursRequest', function() {
      ...
      it('should create an instance of CSSetUsualHoursRequest', function() {
        // TODO: update the code to test CSSetUsualHoursRequest
      ...
      it('should have the property usualHoursData (base name: "UsualHoursData")', function() {
        // TODO: update the code to test the property usualHoursData
        expect(instance).to.have.property('usualHoursData');
        // expect(instance.usualHoursData).to.be(expectedValueLiteral);
      });
