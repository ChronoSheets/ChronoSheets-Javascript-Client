  ...
  describe('ChronoSheetsClient', function() {
    describe('CSBatchUpdateTimesheetRequest', function() {
      ...
      it('should create an instance of CSBatchUpdateTimesheetRequest', function() {
        // TODO: update the code to test CSBatchUpdateTimesheetRequest
      ...
      it('should have the property timesheets (base name: "Timesheets")', function() {
        // TODO: update the code to test the property timesheets
        expect(instance).to.have.property('timesheets');
        // expect(instance.timesheets).to.be(expectedValueLiteral);
      });
