  ...
  describe('ChronoSheetsClient', function() {
    describe('CSDoLoginResponse', function() {
      ...
      it('should create an instance of CSDoLoginResponse', function() {
        // TODO: update the code to test CSDoLoginResponse
      ...
      it('should have the property cSAuthToken (base name: "CSAuthToken")', function() {
        // TODO: update the code to test the property cSAuthToken
        expect(instance).to.have.property('cSAuthToken');
        // expect(instance.cSAuthToken).to.be(expectedValueLiteral);
      });

      it('should have the property loggedInUser (base name: "LoggedInUser")', function() {
        // TODO: update the code to test the property loggedInUser
        expect(instance).to.have.property('loggedInUser');
        // expect(instance.loggedInUser).to.be(expectedValueLiteral);
      });
