...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.ClientSeriesReportItem();
  });
  ...
  describe('ClientSeriesReportItem', function() {
    it('should create an instance of ClientSeriesReportItem', function() {
      // uncomment below and update the code to test ClientSeriesReportItem
      //var instane = new ChronoSheetsApi.ClientSeriesReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.ClientSeriesReportItem);
    });
