...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.OrgReportTrip();
  });
  ...
  describe('OrgReportTrip', function() {
    it('should create an instance of OrgReportTrip', function() {
      // uncomment below and update the code to test OrgReportTrip
      //var instane = new ChronoSheetsApi.OrgReportTrip();
      //expect(instance).to.be.a(ChronoSheetsApi.OrgReportTrip);
    });
