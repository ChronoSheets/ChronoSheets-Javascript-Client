...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertProjectRequest();
  });
  ...
  describe('InsertProjectRequest', function() {
    it('should create an instance of InsertProjectRequest', function() {
      // uncomment below and update the code to test InsertProjectRequest
      //var instane = new ChronoSheetsApi.InsertProjectRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertProjectRequest);
    });
