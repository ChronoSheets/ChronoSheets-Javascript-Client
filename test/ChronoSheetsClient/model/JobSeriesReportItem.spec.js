...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.JobSeriesReportItem();
  });
  ...
  describe('JobSeriesReportItem', function() {
    it('should create an instance of JobSeriesReportItem', function() {
      // uncomment below and update the code to test JobSeriesReportItem
      //var instane = new ChronoSheetsApi.JobSeriesReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.JobSeriesReportItem);
    });
