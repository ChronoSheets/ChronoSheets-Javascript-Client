...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UpdateJobCodeRequest();
  });
  ...
  describe('UpdateJobCodeRequest', function() {
    it('should create an instance of UpdateJobCodeRequest', function() {
      // uncomment below and update the code to test UpdateJobCodeRequest
      //var instane = new ChronoSheetsApi.UpdateJobCodeRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.UpdateJobCodeRequest);
    });
