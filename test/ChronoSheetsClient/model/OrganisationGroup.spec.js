...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.OrganisationGroup();
  });
  ...
  describe('OrganisationGroup', function() {
    it('should create an instance of OrganisationGroup', function() {
      // uncomment below and update the code to test OrganisationGroup
      //var instane = new ChronoSheetsApi.OrganisationGroup();
      //expect(instance).to.be.a(ChronoSheetsApi.OrganisationGroup);
    });
