...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CreateGeoFenceRequest();
  });
  ...
  describe('CreateGeoFenceRequest', function() {
    it('should create an instance of CreateGeoFenceRequest', function() {
      // uncomment below and update the code to test CreateGeoFenceRequest
      //var instane = new ChronoSheetsApi.CreateGeoFenceRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CreateGeoFenceRequest);
    });
