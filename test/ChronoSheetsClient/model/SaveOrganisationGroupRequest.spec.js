...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.SaveOrganisationGroupRequest();
  });
  ...
  describe('SaveOrganisationGroupRequest', function() {
    it('should create an instance of SaveOrganisationGroupRequest', function() {
      // uncomment below and update the code to test SaveOrganisationGroupRequest
      //var instane = new ChronoSheetsApi.SaveOrganisationGroupRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.SaveOrganisationGroupRequest);
    });
