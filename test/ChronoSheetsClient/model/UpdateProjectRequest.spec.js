...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UpdateProjectRequest();
  });
  ...
  describe('UpdateProjectRequest', function() {
    it('should create an instance of UpdateProjectRequest', function() {
      ...
      //var instane = new ChronoSheetsApi.UpdateProjectRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.UpdateProjectRequest);
    });
