...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UpdateTaskRequest();
  });
  ...
  describe('UpdateTaskRequest', function() {
    it('should create an instance of UpdateTaskRequest', function() {
      ...
      //var instane = new ChronoSheetsApi.UpdateTaskRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.UpdateTaskRequest);
    });
