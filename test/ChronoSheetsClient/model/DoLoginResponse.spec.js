...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.DoLoginResponse();
  });
  ...
  describe('DoLoginResponse', function() {
    it('should create an instance of DoLoginResponse', function() {
      // uncomment below and update the code to test DoLoginResponse
      //var instane = new ChronoSheetsApi.DoLoginResponse();
      //expect(instance).to.be.a(ChronoSheetsApi.DoLoginResponse);
    });
