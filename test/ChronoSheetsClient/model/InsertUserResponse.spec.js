...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertUserResponse();
  });
  ...
  describe('InsertUserResponse', function() {
    it('should create an instance of InsertUserResponse', function() {
      // uncomment below and update the code to test InsertUserResponse
      //var instane = new ChronoSheetsApi.InsertUserResponse();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertUserResponse);
    });
