...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.ClientTotalsReportItem();
  });
  ...
  describe('ClientTotalsReportItem', function() {
    it('should create an instance of ClientTotalsReportItem', function() {
      // uncomment below and update the code to test ClientTotalsReportItem
      //var instane = new ChronoSheetsApi.ClientTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.ClientTotalsReportItem);
    });
