...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.OrgReportTimesheetFileAttachment();
  });
  ...
  describe('OrgReportTimesheetFileAttachment', function() {
    it('should create an instance of OrgReportTimesheetFileAttachment', function() {
      // uncomment below and update the code to test OrgReportTimesheetFileAttachment
      //var instane = new ChronoSheetsApi.OrgReportTimesheetFileAttachment();
      //expect(instance).to.be.a(ChronoSheetsApi.OrgReportTimesheetFileAttachment);
    });
