...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.TaskTotalsReportItem();
  });
  ...
  describe('TaskTotalsReportItem', function() {
    it('should create an instance of TaskTotalsReportItem', function() {
      // uncomment below and update the code to test TaskTotalsReportItem
      //var instane = new ChronoSheetsApi.TaskTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.TaskTotalsReportItem);
    });
