...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.SaveVehicleRequest();
  });
  ...
  describe('SaveVehicleRequest', function() {
    it('should create an instance of SaveVehicleRequest', function() {
      // uncomment below and update the code to test SaveVehicleRequest
      //var instane = new ChronoSheetsApi.SaveVehicleRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.SaveVehicleRequest);
    });
