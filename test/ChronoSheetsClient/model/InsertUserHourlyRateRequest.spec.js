...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertUserHourlyRateRequest();
  });
  ...
  describe('InsertUserHourlyRateRequest', function() {
    it('should create an instance of InsertUserHourlyRateRequest', function() {
      // uncomment below and update the code to test InsertUserHourlyRateRequest
      //var instane = new ChronoSheetsApi.InsertUserHourlyRateRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertUserHourlyRateRequest);
    });
