...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.AggregateJobCode();
  });
  ...
  describe('AggregateJobCode', function() {
    it('should create an instance of AggregateJobCode', function() {
      // uncomment below and update the code to test AggregateJobCode
      //var instane = new ChronoSheetsApi.AggregateJobCode();
      //expect(instance).to.be.a(ChronoSheetsApi.AggregateJobCode);
    });
