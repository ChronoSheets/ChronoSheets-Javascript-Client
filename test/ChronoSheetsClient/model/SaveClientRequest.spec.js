...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.SaveClientRequest();
  });
  ...
  describe('SaveClientRequest', function() {
    it('should create an instance of SaveClientRequest', function() {
      // uncomment below and update the code to test SaveClientRequest
      //var instane = new ChronoSheetsApi.SaveClientRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.SaveClientRequest);
    });
