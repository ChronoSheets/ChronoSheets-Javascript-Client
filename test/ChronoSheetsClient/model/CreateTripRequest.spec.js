...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CreateTripRequest();
  });
  ...
  describe('CreateTripRequest', function() {
    it('should create an instance of CreateTripRequest', function() {
      // uncomment below and update the code to test CreateTripRequest
      //var instane = new ChronoSheetsApi.CreateTripRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CreateTripRequest);
    });
