...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.AggregateProject();
  });
  ...
  describe('AggregateProject', function() {
    it('should create an instance of AggregateProject', function() {
      // uncomment below and update the code to test AggregateProject
      //var instane = new ChronoSheetsApi.AggregateProject();
      //expect(instance).to.be.a(ChronoSheetsApi.AggregateProject);
    });
