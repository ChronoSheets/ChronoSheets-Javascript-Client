...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.SetOrganisationGroupUsersRequest();
  });
  ...
  describe('SetOrganisationGroupUsersRequest', function() {
    it('should create an instance of SetOrganisationGroupUsersRequest', function() {
      // uncomment below and update the code to test SetOrganisationGroupUsersRequest
      //var instane = new ChronoSheetsApi.SetOrganisationGroupUsersRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.SetOrganisationGroupUsersRequest);
    });
