...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UpdateUserResponse();
  });
  ...
  describe('UpdateUserResponse', function() {
    it('should create an instance of UpdateUserResponse', function() {
      ...
      //var instane = new ChronoSheetsApi.UpdateUserResponse();
      //expect(instance).to.be.a(ChronoSheetsApi.UpdateUserResponse);
    });
