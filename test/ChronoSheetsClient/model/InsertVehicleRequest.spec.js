...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertVehicleRequest();
  });
  ...
  describe('InsertVehicleRequest', function() {
    it('should create an instance of InsertVehicleRequest', function() {
      // uncomment below and update the code to test InsertVehicleRequest
      //var instane = new ChronoSheetsApi.InsertVehicleRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertVehicleRequest);
    });
