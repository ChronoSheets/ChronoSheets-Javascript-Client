...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.TimesheetFileAttachment();
  });
  ...
  describe('TimesheetFileAttachment', function() {
    it('should create an instance of TimesheetFileAttachment', function() {
      // uncomment below and update the code to test TimesheetFileAttachment
      //var instane = new ChronoSheetsApi.TimesheetFileAttachment();
      //expect(instance).to.be.a(ChronoSheetsApi.TimesheetFileAttachment);
    });
