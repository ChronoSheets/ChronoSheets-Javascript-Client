...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertOrganisationGroupRequest();
  });
  ...
  describe('InsertOrganisationGroupRequest', function() {
    it('should create an instance of InsertOrganisationGroupRequest', function() {
      // uncomment below and update the code to test InsertOrganisationGroupRequest
      //var instane = new ChronoSheetsApi.InsertOrganisationGroupRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertOrganisationGroupRequest);
    });
