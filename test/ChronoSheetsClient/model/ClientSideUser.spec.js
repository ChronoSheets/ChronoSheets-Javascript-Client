...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.ClientSideUser();
  });
  ...
  describe('ClientSideUser', function() {
    it('should create an instance of ClientSideUser', function() {
      // uncomment below and update the code to test ClientSideUser
      //var instane = new ChronoSheetsApi.ClientSideUser();
      //expect(instance).to.be.a(ChronoSheetsApi.ClientSideUser);
    });
