...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.JobCode();
  });
  ...
  describe('JobCode', function() {
    it('should create an instance of JobCode', function() {
      // uncomment below and update the code to test JobCode
      //var instane = new ChronoSheetsApi.JobCode();
      //expect(instance).to.be.a(ChronoSheetsApi.JobCode);
    });
