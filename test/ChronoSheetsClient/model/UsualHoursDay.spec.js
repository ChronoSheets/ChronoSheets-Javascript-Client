...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UsualHoursDay();
  });
  ...
  describe('UsualHoursDay', function() {
    it('should create an instance of UsualHoursDay', function() {
      // uncomment below and update the code to test UsualHoursDay
      //var instane = new ChronoSheetsApi.UsualHoursDay();
      //expect(instance).to.be.a(ChronoSheetsApi.UsualHoursDay);
    });
