...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertTaskRequest();
  });
  ...
  describe('InsertTaskRequest', function() {
    it('should create an instance of InsertTaskRequest', function() {
      // uncomment below and update the code to test InsertTaskRequest
      //var instane = new ChronoSheetsApi.InsertTaskRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertTaskRequest);
    });
