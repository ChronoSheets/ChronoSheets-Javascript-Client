...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.InsertJobCodeRequest();
  });
  ...
  describe('InsertJobCodeRequest', function() {
    it('should create an instance of InsertJobCodeRequest', function() {
      // uncomment below and update the code to test InsertJobCodeRequest
      //var instane = new ChronoSheetsApi.InsertJobCodeRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.InsertJobCodeRequest);
    });
