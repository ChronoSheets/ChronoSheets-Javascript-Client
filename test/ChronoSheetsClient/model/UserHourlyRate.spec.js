...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.UserHourlyRate();
  });
  ...
  describe('UserHourlyRate', function() {
    it('should create an instance of UserHourlyRate', function() {
      // uncomment below and update the code to test UserHourlyRate
      //var instane = new ChronoSheetsApi.UserHourlyRate();
      //expect(instance).to.be.a(ChronoSheetsApi.UserHourlyRate);
    });
