...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.ProjectTotalsReportItem();
  });
  ...
  describe('ProjectTotalsReportItem', function() {
    it('should create an instance of ProjectTotalsReportItem', function() {
      // uncomment below and update the code to test ProjectTotalsReportItem
      //var instane = new ChronoSheetsApi.ProjectTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.ProjectTotalsReportItem);
    });
