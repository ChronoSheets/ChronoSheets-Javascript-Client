...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUserJobFavourite();
  });
  ...
  describe('CSUserJobFavourite', function() {
    it('should create an instance of CSUserJobFavourite', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUserJobFavourite();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUserJobFavourite);
    });
