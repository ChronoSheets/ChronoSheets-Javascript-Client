...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUpdateOrganisationResponse();
  });
  ...
  describe('CSUpdateOrganisationResponse', function() {
    it('should create an instance of CSUpdateOrganisationResponse', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUpdateOrganisationResponse();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUpdateOrganisationResponse);
    });
