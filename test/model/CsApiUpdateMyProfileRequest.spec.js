...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiUpdateMyProfileRequest();
  });
  ...
  describe('CsApiUpdateMyProfileRequest', function() {
    it('should create an instance of CsApiUpdateMyProfileRequest', function() {
      // uncomment below and update the code to test CsApiUpdateMyProfileRequest
      //var instane = new ChronoSheetsApi.CsApiUpdateMyProfileRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiUpdateMyProfileRequest);
    });
