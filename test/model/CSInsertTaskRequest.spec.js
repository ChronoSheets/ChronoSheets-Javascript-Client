...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSInsertTaskRequest();
  });
  ...
  describe('CSInsertTaskRequest', function() {
    it('should create an instance of CSInsertTaskRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSInsertTaskRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSInsertTaskRequest);
    });
