...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiAggregateJobCode();
  });
  ...
  describe('CsApiAggregateJobCode', function() {
    it('should create an instance of CsApiAggregateJobCode', function() {
      // uncomment below and update the code to test CsApiAggregateJobCode
      //var instane = new ChronoSheetsApi.CsApiAggregateJobCode();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiAggregateJobCode);
    });
