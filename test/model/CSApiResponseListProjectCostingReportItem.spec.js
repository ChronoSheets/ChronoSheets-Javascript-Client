...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSApiResponseListProjectCostingReportItem();
  });
  ...
  describe('CSApiResponseListProjectCostingReportItem', function() {
    it('should create an instance of CSApiResponseListProjectCostingReportItem', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSApiResponseListProjectCostingReportItem();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSApiResponseListProjectCostingReportItem);
    });
