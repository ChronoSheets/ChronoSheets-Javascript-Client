...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUpdateProfileResponse();
  });
  ...
  describe('CSUpdateProfileResponse', function() {
    it('should create an instance of CSUpdateProfileResponse', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUpdateProfileResponse();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUpdateProfileResponse);
    });
