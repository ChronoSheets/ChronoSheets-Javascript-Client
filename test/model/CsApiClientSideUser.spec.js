...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiClientSideUser();
  });
  ...
  describe('CsApiClientSideUser', function() {
    it('should create an instance of CsApiClientSideUser', function() {
      // uncomment below and update the code to test CsApiClientSideUser
      //var instane = new ChronoSheetsApi.CsApiClientSideUser();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiClientSideUser);
    });
