...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSInsertOrganisationGroupRequest();
  });
  ...
  describe('CSInsertOrganisationGroupRequest', function() {
    it('should create an instance of CSInsertOrganisationGroupRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSInsertOrganisationGroupRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSInsertOrganisationGroupRequest);
    });
