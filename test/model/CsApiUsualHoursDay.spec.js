...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiUsualHoursDay();
  });
  ...
  describe('CsApiUsualHoursDay', function() {
    it('should create an instance of CsApiUsualHoursDay', function() {
      // uncomment below and update the code to test CsApiUsualHoursDay
      //var instane = new ChronoSheetsApi.CsApiUsualHoursDay();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiUsualHoursDay);
    });
