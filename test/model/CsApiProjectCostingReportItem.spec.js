...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiProjectCostingReportItem();
  });
  ...
  describe('CsApiProjectCostingReportItem', function() {
    it('should create an instance of CsApiProjectCostingReportItem', function() {
      // uncomment below and update the code to test CsApiProjectCostingReportItem
      //var instane = new ChronoSheetsApi.CsApiProjectCostingReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiProjectCostingReportItem);
    });
