...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiJobTotalsReportItem();
  });
  ...
  describe('CsApiJobTotalsReportItem', function() {
    it('should create an instance of CsApiJobTotalsReportItem', function() {
      // uncomment below and update the code to test CsApiJobTotalsReportItem
      //var instane = new ChronoSheetsApi.CsApiJobTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiJobTotalsReportItem);
    });
