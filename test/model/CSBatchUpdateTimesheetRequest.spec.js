...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSBatchUpdateTimesheetRequest();
  });
  ...
  describe('CSBatchUpdateTimesheetRequest', function() {
    it('should create an instance of CSBatchUpdateTimesheetRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSBatchUpdateTimesheetRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSBatchUpdateTimesheetRequest);
    });
