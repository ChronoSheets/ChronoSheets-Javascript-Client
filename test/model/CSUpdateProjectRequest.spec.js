...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUpdateProjectRequest();
  });
  ...
  describe('CSUpdateProjectRequest', function() {
    it('should create an instance of CSUpdateProjectRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUpdateProjectRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUpdateProjectRequest);
    });
