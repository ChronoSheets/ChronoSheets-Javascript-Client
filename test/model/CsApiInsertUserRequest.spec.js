...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiInsertUserRequest();
  });
  ...
  describe('CsApiInsertUserRequest', function() {
    it('should create an instance of CsApiInsertUserRequest', function() {
      // uncomment below and update the code to test CsApiInsertUserRequest
      //var instane = new ChronoSheetsApi.CsApiInsertUserRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiInsertUserRequest);
    });
