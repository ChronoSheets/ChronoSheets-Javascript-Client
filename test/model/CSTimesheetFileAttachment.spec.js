...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.CSTimesheetFileAttachment();
  });
  ...
  describe('CSTimesheetFileAttachment', function() {
    it('should create an instance of CSTimesheetFileAttachment', function() {
      // uncomment below and update the code to test CSTimesheetFileAttachment
      //var instane = new JavascriptApiClientForChronoSheets.CSTimesheetFileAttachment();
      //expect(instance).to.be.a(JavascriptApiClientForChronoSheets.CSTimesheetFileAttachment);
    });
