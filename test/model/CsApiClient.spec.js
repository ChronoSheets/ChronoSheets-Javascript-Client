...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiClient();
  });
  ...
  describe('CsApiClient', function() {
    it('should create an instance of CsApiClient', function() {
      // uncomment below and update the code to test CsApiClient
      //var instane = new ChronoSheetsApi.CsApiClient();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiClient);
    });
