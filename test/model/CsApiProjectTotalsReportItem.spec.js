...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiProjectTotalsReportItem();
  });
  ...
  describe('CsApiProjectTotalsReportItem', function() {
    it('should create an instance of CsApiProjectTotalsReportItem', function() {
      // uncomment below and update the code to test CsApiProjectTotalsReportItem
      //var instane = new ChronoSheetsApi.CsApiProjectTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiProjectTotalsReportItem);
    });
