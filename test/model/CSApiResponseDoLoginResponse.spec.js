...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSApiResponseDoLoginResponse();
  });
  ...
  describe('CSApiResponseDoLoginResponse', function() {
    it('should create an instance of CSApiResponseDoLoginResponse', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSApiResponseDoLoginResponse();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSApiResponseDoLoginResponse);
    });
