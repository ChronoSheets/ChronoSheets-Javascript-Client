...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.CSApiResponseDoLoginResponse();
  });
  ...
  describe('CSApiResponseDoLoginResponse', function() {
    it('should create an instance of CSApiResponseDoLoginResponse', function() {
      ...
      //var instane = new JavascriptApiClientForChronoSheets.CSApiResponseDoLoginResponse();
      //expect(instance).to.be.a(JavascriptApiClientForChronoSheets.CSApiResponseDoLoginResponse);
    });
