...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.CSInsertClientRequest();
  });
  ...
  describe('CSInsertClientRequest', function() {
    it('should create an instance of CSInsertClientRequest', function() {
      ...
      //var instane = new JavascriptApiClientForChronoSheets.CSInsertClientRequest();
      //expect(instance).to.be.a(JavascriptApiClientForChronoSheets.CSInsertClientRequest);
    });
