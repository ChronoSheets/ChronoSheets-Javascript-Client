...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CSInsertClientRequest();
  });
  ...
  describe('CSInsertClientRequest', function() {
    it('should create an instance of CSInsertClientRequest', function() {
      ...
      //var instane = new ChronoSheetsApi.CSInsertClientRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CSInsertClientRequest);
    });
