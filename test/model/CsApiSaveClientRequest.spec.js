...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiSaveClientRequest();
  });
  ...
  describe('CsApiSaveClientRequest', function() {
    it('should create an instance of CsApiSaveClientRequest', function() {
      // uncomment below and update the code to test CsApiSaveClientRequest
      //var instane = new ChronoSheetsApi.CsApiSaveClientRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiSaveClientRequest);
    });
