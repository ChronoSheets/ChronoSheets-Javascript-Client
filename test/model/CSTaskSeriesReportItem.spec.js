...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSTaskSeriesReportItem();
  });
  ...
  describe('CSTaskSeriesReportItem', function() {
    it('should create an instance of CSTaskSeriesReportItem', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSTaskSeriesReportItem();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSTaskSeriesReportItem);
    });
