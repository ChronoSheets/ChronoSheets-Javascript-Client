...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSApiResponseUpdateProfileResponse();
  });
  ...
  describe('CSApiResponseUpdateProfileResponse', function() {
    it('should create an instance of CSApiResponseUpdateProfileResponse', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSApiResponseUpdateProfileResponse();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSApiResponseUpdateProfileResponse);
    });
