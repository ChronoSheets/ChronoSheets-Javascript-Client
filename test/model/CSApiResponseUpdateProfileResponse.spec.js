...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.CSApiResponseUpdateProfileResponse();
  });
  ...
  describe('CSApiResponseUpdateProfileResponse', function() {
    it('should create an instance of CSApiResponseUpdateProfileResponse', function() {
      ...
      //var instane = new JavascriptApiClientForChronoSheets.CSApiResponseUpdateProfileResponse();
      //expect(instance).to.be.a(JavascriptApiClientForChronoSheets.CSApiResponseUpdateProfileResponse);
    });
