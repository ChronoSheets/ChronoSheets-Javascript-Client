...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSSetOrganisationGroupUsersRequest();
  });
  ...
  describe('CSSetOrganisationGroupUsersRequest', function() {
    it('should create an instance of CSSetOrganisationGroupUsersRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSSetOrganisationGroupUsersRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSSetOrganisationGroupUsersRequest);
    });
