...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiUpdateTaskRequest();
  });
  ...
  describe('CsApiUpdateTaskRequest', function() {
    it('should create an instance of CsApiUpdateTaskRequest', function() {
      // uncomment below and update the code to test CsApiUpdateTaskRequest
      //var instane = new ChronoSheetsApi.CsApiUpdateTaskRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiUpdateTaskRequest);
    });
