...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSClientSideUser();
  });
  ...
  describe('CSClientSideUser', function() {
    it('should create an instance of CSClientSideUser', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSClientSideUser();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSClientSideUser);
    });
