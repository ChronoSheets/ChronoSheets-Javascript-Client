...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSApiResponseForPaginatedListRawReportItem();
  });
  ...
  describe('CSApiResponseForPaginatedListRawReportItem', function() {
    it('should create an instance of CSApiResponseForPaginatedListRawReportItem', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSApiResponseForPaginatedListRawReportItem();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSApiResponseForPaginatedListRawReportItem);
    });
