...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSApiResponseListTimesheetTask();
  });
  ...
  describe('CSApiResponseListTimesheetTask', function() {
    it('should create an instance of CSApiResponseListTimesheetTask', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSApiResponseListTimesheetTask();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSApiResponseListTimesheetTask);
    });
