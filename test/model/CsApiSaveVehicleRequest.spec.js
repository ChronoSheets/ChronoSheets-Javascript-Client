...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiSaveVehicleRequest();
  });
  ...
  describe('CsApiSaveVehicleRequest', function() {
    it('should create an instance of CsApiSaveVehicleRequest', function() {
      // uncomment below and update the code to test CsApiSaveVehicleRequest
      //var instane = new ChronoSheetsApi.CsApiSaveVehicleRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiSaveVehicleRequest);
    });
