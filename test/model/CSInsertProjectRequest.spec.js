...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSInsertProjectRequest();
  });
  ...
  describe('CSInsertProjectRequest', function() {
    it('should create an instance of CSInsertProjectRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSInsertProjectRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSInsertProjectRequest);
    });
