...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiProject();
  });
  ...
  describe('CsApiProject', function() {
    it('should create an instance of CsApiProject', function() {
      // uncomment below and update the code to test CsApiProject
      //var instane = new ChronoSheetsApi.CsApiProject();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiProject);
    });
