...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUpdateUserRequest();
  });
  ...
  describe('CSUpdateUserRequest', function() {
    it('should create an instance of CSUpdateUserRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUpdateUserRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUpdateUserRequest);
    });
