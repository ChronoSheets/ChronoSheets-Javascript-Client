...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.CSOrganisation();
  });
  ...
  describe('CSOrganisation', function() {
    it('should create an instance of CSOrganisation', function() {
      ...
      //var instane = new JavascriptApiClientForChronoSheets.CSOrganisation();
      //expect(instance).to.be.a(JavascriptApiClientForChronoSheets.CSOrganisation);
    });
