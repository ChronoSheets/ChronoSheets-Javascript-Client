...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSFleetVehicle();
  });
  ...
  describe('CSFleetVehicle', function() {
    it('should create an instance of CSFleetVehicle', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSFleetVehicle();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSFleetVehicle);
    });
