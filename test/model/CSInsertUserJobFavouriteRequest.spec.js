...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSInsertUserJobFavouriteRequest();
  });
  ...
  describe('CSInsertUserJobFavouriteRequest', function() {
    it('should create an instance of CSInsertUserJobFavouriteRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSInsertUserJobFavouriteRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSInsertUserJobFavouriteRequest);
    });
