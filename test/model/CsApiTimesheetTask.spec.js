...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiTimesheetTask();
  });
  ...
  describe('CsApiTimesheetTask', function() {
    it('should create an instance of CsApiTimesheetTask', function() {
      // uncomment below and update the code to test CsApiTimesheetTask
      //var instane = new ChronoSheetsApi.CsApiTimesheetTask();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiTimesheetTask);
    });
