...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSSetUsualHoursRequest();
  });
  ...
  describe('CSSetUsualHoursRequest', function() {
    it('should create an instance of CSSetUsualHoursRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSSetUsualHoursRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSSetUsualHoursRequest);
    });
