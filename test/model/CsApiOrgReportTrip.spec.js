...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiOrgReportTrip();
  });
  ...
  describe('CsApiOrgReportTrip', function() {
    it('should create an instance of CsApiOrgReportTrip', function() {
      // uncomment below and update the code to test CsApiOrgReportTrip
      //var instane = new ChronoSheetsApi.CsApiOrgReportTrip();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiOrgReportTrip);
    });
