...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiRawReportItem();
  });
  ...
  describe('CsApiRawReportItem', function() {
    it('should create an instance of CsApiRawReportItem', function() {
      // uncomment below and update the code to test CsApiRawReportItem
      //var instane = new ChronoSheetsApi.CsApiRawReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiRawReportItem);
    });
