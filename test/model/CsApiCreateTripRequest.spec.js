...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiCreateTripRequest();
  });
  ...
  describe('CsApiCreateTripRequest', function() {
    it('should create an instance of CsApiCreateTripRequest', function() {
      // uncomment below and update the code to test CsApiCreateTripRequest
      //var instane = new ChronoSheetsApi.CsApiCreateTripRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiCreateTripRequest);
    });
