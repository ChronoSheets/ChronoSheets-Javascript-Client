...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheChronoSheetsApi.CSUpdateTaskRequest();
  });
  ...
  describe('CSUpdateTaskRequest', function() {
    it('should create an instance of CSUpdateTaskRequest', function() {
      ...
      //var instane = new TheChronoSheetsApi.CSUpdateTaskRequest();
      //expect(instance).to.be.a(TheChronoSheetsApi.CSUpdateTaskRequest);
    });
