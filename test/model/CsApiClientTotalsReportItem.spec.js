...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiClientTotalsReportItem();
  });
  ...
  describe('CsApiClientTotalsReportItem', function() {
    it('should create an instance of CsApiClientTotalsReportItem', function() {
      // uncomment below and update the code to test CsApiClientTotalsReportItem
      //var instane = new ChronoSheetsApi.CsApiClientTotalsReportItem();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiClientTotalsReportItem);
    });
