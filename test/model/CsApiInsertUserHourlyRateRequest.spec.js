...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChronoSheetsApi.CsApiInsertUserHourlyRateRequest();
  });
  ...
  describe('CsApiInsertUserHourlyRateRequest', function() {
    it('should create an instance of CsApiInsertUserHourlyRateRequest', function() {
      // uncomment below and update the code to test CsApiInsertUserHourlyRateRequest
      //var instane = new ChronoSheetsApi.CsApiInsertUserHourlyRateRequest();
      //expect(instance).to.be.a(ChronoSheetsApi.CsApiInsertUserHourlyRateRequest);
    });
