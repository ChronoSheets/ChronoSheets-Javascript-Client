...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptApiClientForChronoSheets.TimesheetsApi();
  });
  ...
  describe('TimesheetsApi', function() {
    ...
    describe('timesheetsDeleteTimesheet', function() {
      it('should call timesheetsDeleteTimesheet successfully', function(done) {
        ...
        //instance.timesheetsDeleteTimesheet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('timesheetsUpdateTimesheets', function() {
      it('should call timesheetsUpdateTimesheets successfully', function(done) {
        //uncomment below and update the code to test timesheetsUpdateTimesheets
        //instance.timesheetsUpdateTimesheets(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
