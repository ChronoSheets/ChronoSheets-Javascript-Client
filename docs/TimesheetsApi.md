# JavascriptApiClientForChronoSheets.TimesheetsApi
...
var apiInstance = new JavascriptApiClientForChronoSheets.TimesheetsApi();

var request = new JavascriptApiClientForChronoSheets.CSTimesheet(); // CSTimesheet | A Timesheet Request object containing values for the new Timesheet to create
...
var request = new JavascriptApiClientForChronoSheets.CSBatchUpdateTimesheetRequest(); // CSBatchUpdateTimesheetRequest | A BatchUpdateTimesheet Request object containing values for the new Timesheets to create
