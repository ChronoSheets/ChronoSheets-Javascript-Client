...
var apiInstance = new TheChronoSheetsApi.TripsApi();

var request = new TheChronoSheetsApi.CSCreateTripRequest(); // CSCreateTripRequest | A Create Trip Request object containing values for the new Trip to create
