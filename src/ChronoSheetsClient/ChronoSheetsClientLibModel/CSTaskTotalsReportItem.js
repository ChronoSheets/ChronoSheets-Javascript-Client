...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TheChronoSheetsApi.CSTaskTotalsReportItem = factory(root.TheChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>CSTaskTotalsReportItem</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSTaskTotalsReportItem
   * @class
   */
  ...
  /**
   * Constructs a <code>CSTaskTotalsReportItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSTaskTotalsReportItem} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSTaskTotalsReportItem} The populated <code>CSTaskTotalsReportItem</code> instance.
   */
