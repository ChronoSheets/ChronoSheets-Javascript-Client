...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiOrgReportTrip = factory(root.ChronoSheetsApi.ApiClient, root.ChronoSheetsApi.CsApiTripCoordinate);
  }
  ...
  /**
   * The CsApiOrgReportTrip model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrgReportTrip
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiOrgReportTrip</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrgReportTrip
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiOrgReportTrip</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrgReportTrip} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrgReportTrip} The populated <code>CsApiOrgReportTrip</code> instance.
   */
