...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiJobTotalsReportItem = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiJobTotalsReportItem model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiJobTotalsReportItem
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiJobTotalsReportItem</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiJobTotalsReportItem
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiJobTotalsReportItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiJobTotalsReportItem} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiJobTotalsReportItem} The populated <code>CsApiJobTotalsReportItem</code> instance.
   */
