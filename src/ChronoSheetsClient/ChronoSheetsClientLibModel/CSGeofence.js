...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CSGeofence = factory(root.ChronoSheetsApi.ApiClient, root.ChronoSheetsApi.CSBasicCoordinate);
  }
}(this, function(ApiClient, CSBasicCoordinate) {
  'use strict';

  /**
   * The CSGeofence model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CSGeofence</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence
   * @class
   */
  ...
  /**
   * Constructs a <code>CSGeofence</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence} The populated <code>CSGeofence</code> instance.
   */
  ...
  /**
   * @member {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence.TriggerSettingsEnum} triggerSettings
   */
  ...
  /**
   * @member {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSGeofence.AlertSettingsEnum} alertSettings
   */
