...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiInsertClientRequest = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiInsertClientRequest model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiInsertClientRequest
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiInsertClientRequest</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiInsertClientRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiInsertClientRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiInsertClientRequest} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiInsertClientRequest} The populated <code>CsApiInsertClientRequest</code> instance.
   */
