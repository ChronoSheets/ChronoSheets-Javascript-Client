...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiUpdateUserRequest = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiUpdateUserRequest model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiUpdateUserRequest
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiUpdateUserRequest</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiUpdateUserRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiUpdateUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiUpdateUserRequest} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiUpdateUserRequest} The populated <code>CsApiUpdateUserRequest</code> instance.
   */
