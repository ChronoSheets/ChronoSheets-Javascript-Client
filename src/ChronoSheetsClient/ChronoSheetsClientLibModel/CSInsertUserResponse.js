...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TheChronoSheetsApi.CSInsertUserResponse = factory(root.TheChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>CSInsertUserResponse</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSInsertUserResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CSInsertUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSInsertUserResponse} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSInsertUserResponse} The populated <code>CSInsertUserResponse</code> instance.
   */
