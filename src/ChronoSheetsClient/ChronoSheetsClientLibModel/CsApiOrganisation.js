...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiOrganisation = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiOrganisation model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrganisation
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiOrganisation</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrganisation
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiOrganisation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrganisation} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiOrganisation} The populated <code>CsApiOrganisation</code> instance.
   */
