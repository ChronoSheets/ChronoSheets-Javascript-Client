...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiSaveClientRequest = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiSaveClientRequest model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiSaveClientRequest
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiSaveClientRequest</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiSaveClientRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiSaveClientRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiSaveClientRequest} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiSaveClientRequest} The populated <code>CsApiSaveClientRequest</code> instance.
   */
