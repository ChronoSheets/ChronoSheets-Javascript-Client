...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiFleetVehicle = factory(root.ChronoSheetsApi.ApiClient);
  }
  ...
  /**
   * The CsApiFleetVehicle model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiFleetVehicle
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiFleetVehicle</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiFleetVehicle
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiFleetVehicle</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiFleetVehicle} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiFleetVehicle} The populated <code>CsApiFleetVehicle</code> instance.
   */
