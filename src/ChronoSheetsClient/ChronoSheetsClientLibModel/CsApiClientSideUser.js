...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ChronoSheetsApi.CsApiClientSideUser = factory(root.ChronoSheetsApi.ApiClient, root.ChronoSheetsApi.CsApiOrganisation);
  }
  ...
  /**
   * The CsApiClientSideUser model module.
   * @module ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiClientSideUser
   * @version v1
   */

  /**
   * Constructs a new <code>CsApiClientSideUser</code>.
   * @alias module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiClientSideUser
   * @class
   */
  ...
  /**
   * Constructs a <code>CsApiClientSideUser</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiClientSideUser} obj Optional instance to populate.
   * @return {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CsApiClientSideUser} The populated <code>CsApiClientSideUser</code> instance.
   */
