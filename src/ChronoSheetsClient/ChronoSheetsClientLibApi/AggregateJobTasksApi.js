...
* @version 1.0.0
*/
export default class AggregateJobTasksApi {
    ...
    */
     ...
     * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/ApiResponseListAggregateJobCode} data The data returned by the service call.
     ...
     * data is of type: {@link module:ChronoSheetsClient/ChronoSheetsClientLibModel/ApiResponseListAggregateJobCode}
     */
    aggregateJobTasksGetAggregateJobTasks(xChronosheetsAuth, callback) {
      let postBody = null;
      ...
      let returnType = ApiResponseListAggregateJobCode;
