...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ChronoSheetsClient/ApiClient', 'ChronoSheetsClient/ChronoSheetsClientLibModel/CSApiResponseBoolean', 'ChronoSheetsClient/ChronoSheetsClientLibModel/CSApiResponseForPaginatedListTimesheetFileAttachment', 'ChronoSheetsClient/ChronoSheetsClientLibModel/CSApiResponseTimesheetFileAttachment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../ChronoSheetsClientLibModel/CSApiResponseBoolean'), require('../ChronoSheetsClientLibModel/CSApiResponseForPaginatedListTimesheetFileAttachment'), require('../ChronoSheetsClientLibModel/CSApiResponseTimesheetFileAttachment'));
  } else {
    // Browser globals (root is window)
    if (!root.ChronoSheetsApi) {
      root.ChronoSheetsApi = {};
    }
    root.ChronoSheetsApi.FileAttachmentsApi = factory(root.ChronoSheetsApi.ApiClient, root.ChronoSheetsApi.CSApiResponseBoolean, root.ChronoSheetsApi.CSApiResponseForPaginatedListTimesheetFileAttachment, root.ChronoSheetsApi.CSApiResponseTimesheetFileAttachment);
  }
}(this, function(ApiClient, CSApiResponseBoolean, CSApiResponseForPaginatedListTimesheetFileAttachment, CSApiResponseTimesheetFileAttachment) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSApiResponseTimesheetFileAttachment} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:ChronoSheetsClient/ChronoSheetsClientLibModel/CSApiResponseTimesheetFileAttachment}
     */
    this.fileAttachmentsGetFileAttachmentById = function(fileAttachmentId, xChronosheetsAuth, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml', 'multipart/form-data'];
      var returnType = CSApiResponseTimesheetFileAttachment;
